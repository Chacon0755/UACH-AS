...
CREATE TABLE `asesorias` (
  ...
  KEY `fk_id_docente_horario` (`id_docente_horario`),
  ...
  CONSTRAINT `fk_id_docente_horario` FOREIGN KEY (`id_docente_horario`) REFERENCES `docente_horario` (`id_docente_horario`),
...
INSERT INTO `asesorias` VALUES (16,348760,2419,58,0,155),(17,339875,870102,91,0,213),(18,339875,870102,91,1,214),(19,339875,870102,92,0,212);
